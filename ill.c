						...
						if(cptr->lower[i].count==0)
						{
							if(cptr->rac_list!=NULL)
							{
								...
								while(plist->next!=NULL)
								{
									...
									cptr->lower->count++;
									cptr->lower->id=cptr->rac_list->id;				
						...
						if(cptr->upper[i].count==0)
						{
							if(cptr->rac_list!=NULL)
							{
								...
								while(plist->next!=NULL)
								{
									...
									cptr->upper->count++;
									cptr->upper->id=cptr->rac_list->id;																
									plist->next=cptr->rac_list;
									cptr->rac_list->prev=plist;
									cptr->rac_list=cptr->rac_list->next;
									(plist->next)->next=NULL;
						...
						if(cptr->middle[i].count==0)
						{
							if(cptr->rac_list!=NULL)
							{
								...
								while(plist->next!=NULL)
								{
									...
									cptr->middle->count++;
									cptr->middle->id=cptr->rac_list->id;																
									plist->next=cptr->rac_list;
									cptr->rac_list->prev=plist;
									cptr->rac_list=cptr->rac_list->next;
									(plist->next)->next=NULL;
						...
						if(cptr->side_lower[i].count==0)
						{
							if(cptr->rac_list!=NULL)
							{
								...
								while(plist->next!=NULL)
								{
									...
									cptr->side_lower->count++;
									cptr->side_upper->id=cptr->rac_list->id;																
									plist->next=cptr->rac_list;
									cptr->rac_list->prev=plist;
									cptr->rac_list=cptr->rac_list->next;
									(plist->next)->next=NULL;
...
//	 	 freezeBooking(cptr);
	  ...
	  fclose(fp);
	  	...
	  	fp=fp = fopen("waiting_data.txt", "w");
